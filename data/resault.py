...
class ResaultRow:
    ...
    def from_json(self, json: dict):
        ...
        if 'resault_1' in keys and json['resault_1'] != None:
            self.resault_1 = Resault().from_json(json['resault_1'])

        if 'resault_2' in keys and json['resault_2'] != None:
            self.resault_2 = Resault().from_json(json['resault_2'])

        if 'resault_3' in keys and json['resault_3'] != None:
            self.resault_3 = Resault().from_json(json['resault_3'])
