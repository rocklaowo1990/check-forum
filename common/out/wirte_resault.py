...
def write_resault(target_path: str, w: data.Work):
    w_path = os.path.join(target_path, '%s的结果.txt' % (w.name))
    ...
    for s in w.history.failure:
        ...
        if s.resault_1.url != '':
            ...
            if s.resault_1.repeated != []:
                ...
                content += '论坛的重复: 无\n'
                content += '论坛的访问: 失败\n'
            elif not s.resault_1.is_have_table:
                content += '论坛的重复: 无\n'
                content += '论坛的访问: 成功\n'
                content += '论坛的表格: 没有找到(看下论坛地址是不是列表的那一页)\n'
                ...
                content += '查看的人数: %d %s\n' % (
                    s.resault_1.read,
                    '合格' if s.resault_1.read >= data.const.min_read else '不合格')
        ...
        if s.resault_2.url != '':
            ...
            if s.resault_2.repeated != []:
                ...
                content += '论坛的重复: 无\n'
                content += '论坛的访问: 失败\n'
            elif not s.resault_2.is_have_table:
                content += '论坛的重复: 无\n'
                content += '论坛的访问: 成功\n'
                content += '论坛的表格: 没有找到(看下论坛地址是不是列表的那一页)\n'
                ...
                content += '查看的人数: %d %s\n' % (
                    s.resault_2.read,
                    '合格' if s.resault_2.read >= data.const.min_read else '不合格')
        ...
        if s.resault_3.url != '':
            ...
            if s.resault_3.repeated != []:
                ...
                content += '论坛的重复: 无\n'
                content += '论坛的访问: 失败\n'
            elif not s.resault_3.is_have_table:
                content += '论坛的重复: 无\n'
                content += '论坛的访问: 成功\n'
                content += '论坛的表格: 没有找到(看下论坛地址是不是列表的那一页)\n'
                ...
                content += '查看的人数: %d %s\n' % (
                    s.resault_3.read,
                    '合格' if s.resault_3.read >= data.const.min_read else '不合格')
